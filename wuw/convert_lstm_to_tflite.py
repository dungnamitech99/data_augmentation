...
if __name__ == "__main__":
    ...
    model.load_variables_from_checkpoint(
        sess, get_checkpoint_path("/tf/train_hiFPToi/exp/lstm-add-ftel5")
    )
    ...
    pb_path = os.path.join("/tf/train_hiFPToi/exp/lstm-add-ftel5", "model.pb")
    ...
    with open("/tf/train_hiFPToi/exp/lstm-add-ftel5/model_e2e.tflite", "wb") as f:
